...
#create a list of markers for each algorithm without repetition of markers
markers = {
    r'CTS-G ($\gamma = 0.1$)': '.',
    r'CL-SG ($\gamma = 0.1$)': ',',
    r'CombUCB': 'o',
...
plt.yscale('log')
plt.savefig("results/CSMAB_regrets_10arms_Bernoulli_varying_availability.pdf", bbox_inches='tight')
plt.show()
...
plt.xlabel('t',fontsize=10)
plt.ylabel('Regret',fontsize=10)
plt.savefig("results/CSMAB_regrets_10arms_Bernoulli_all_varying_availability.pdf", bbox_inches='tight')
plt.show()
...
plt.ylabel('Regret',fontsize=10)
plt.yscale('log')
plt.savefig("results/CSMAB_regrets_10arms_Bernoulli_CTS-G_CL-SG_varying_alpha.pdf", bbox_inches='tight')
plt.show()
...
plt.ylabel('Regret',fontsize=10)
plt.yscale('log')
plt.savefig("results/CSMAB_regrets_10arms_Bernoulli_CTS-G_CL-SG_CL-LG_varying_alpha.pdf", bbox_inches='tight')
plt.show()
