...
instance.plot_regrets(errorbar=False, 
...
instance.plot_regrets(errorbar=False, 
                        filename="./results/CSMAB_regrets_20arms_Bernoulli_all.pdf", 
                        pltlow_bound = False, legend=True)
...
instance.plot_regrets(errorbar=False, 
                        filename="./results/CSMAB_regrets_20arms_diffgamma_CTS_G.pdf", 
                        pltlow_bound = False, legend=True)
...
instance.plot_regrets(errorbar=False, 
                        filename="./results/CSMAB_regrets_20arms_diffgamma_CL_SG.pdf", 
                        pltlow_bound = False, legend=True)
...
instance.plot_regrets(errorbar=False, 
                        filename="./results/CSMAB_regrets_20arms_diffgamma_CL_LG.pdf", 
                        pltlow_bound = False, legend=True)
...
instance.plot_regrets(errorbar=False, 
                        filename="./results/CSMAB_regrets_20arms_diffgamma_all.pdf", 
                        pltlow_bound = False, legend=True)
# %%
